...
class PluginManager:
    ...
    async def download_from_message(message: Message) -> str:
        ...
        if (
            reply
            and reply.media
            and reply.media.document
            and reply.media.document.attributes
            and reply.media.document.attributes[0].file_name.endswith(".py")
        ):
            ...
            and message.media.document.attributes[0].file_name.endswith(".py")
        ):
