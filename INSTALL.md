...
```
curl -fsSL https://raw.githubusercontent.com/sharkbeee/PagerMaid/main/utils/docker.sh | sh
```

如果您想在运行之前检查脚本内容：

```
curl https://raw.githubusercontent.com/sharkbeee/PagerMaid/main/utils/docker.sh -o docker.sh
vim docker.sh
